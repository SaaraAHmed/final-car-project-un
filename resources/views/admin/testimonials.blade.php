                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      @foreach($testimonials as $testimonial)
                        <tr>
                          ...
                          <td><img src="{{ asset('adminAssets/./images/edit.png') }}" alt="Edit"> <a href="{{route('editTestimonial', $testimonial->id)}}">editTestimonial</a></td>
                          <td><img src="{{ asset('adminAssets/./images/delete.png') }}" alt="Delete"><a href="{{route('destroyTestimonial', $testimonial->id)}}">destroyTestimonial</a></td>
                        </tr>
                        @endforeach
