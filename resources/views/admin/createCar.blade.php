									...
									<form action="{{route('storeCar')}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="title" required="required" class="form-control "  name="name" value="{{old('name')}}">
												@error('name')
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" required="required" class="form-control" name="comment">{{old('comment')}}</textarea>
												@error('comment')
												<div class="alert alert-danger">
													<strong>Error!!</strong> {{$message}}
												</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="passengers" class="form-control" type="number" name="passenger" required="required"  value="{{old('passenger')}}">
												@error('passenger')
												<div class="alert alert-danger">
													<strong>Error!!</strong> {{$message}}
												</div>
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" name="published" )>published
													@error('published')
												<div class="alert alert-danger">
													<strong>Error!!</strong> {{$message}}
												</div>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<button type="submit" class="btn btn-success" href="{{route('storeCar')}}"  >Add</button>
											</div>
										</div>
