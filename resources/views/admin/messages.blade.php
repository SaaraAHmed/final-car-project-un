                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        @foreach($messages as $message) 
                          ...
                          <td>{{$message->email}}</td>
                          <td><img src="{{ asset('adminAssets/./images/edit.png') }}" alt="show"> <a href="{{route('showMessage', $message->id)}}">showMessage</a></td>
                          <td><img src="{{ asset('adminAssets/./images/delete.png') }}" alt="Delete"><a href="{{route('destroyMessage', $message->id)}}">destroyMessage</a></td>
                        </tr>
                        @endforeach
