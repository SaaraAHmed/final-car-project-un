                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      @foreach($categories as $category)
                        <tr>
                          ...
                          <td><img src="{{ asset('adminAssets/./images/edit.png') }}" alt="Edit"><a href="{{route('editCategory', $category->id)}}">editCategory</td>
                          <td><img src="{{ asset('adminAssets/./images/delete.png') }}" alt="Delete"><a href="{{route('destroyCategory', $category->id)}}">destroyCategory</td>
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
