                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody> 
                        ...
                        <tr>
                          ...
                          <td><img src="{{ asset('adminAssets/./images/edit.png') }}" alt="Edit"><a href="{{route('editCar', $car->id)}}">editCar</a></td>
                          <td><img src="{{ asset('adminAssets/./images/delete.png') }}" alt="Delete"><a href="{{route('destroyCar', $car->id)}}">destroyCar</a></td>
