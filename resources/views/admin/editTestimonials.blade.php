					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="{{route('updateTestimonial', $testimonial->id)}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
								        	@csrf
											@method('put')
									   <div class="item form-group">
                                        ...
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="position" required="required" class="form-control "name="job" value="{{$testimonial->job}}" >
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="file" id="image" required="required" class="form-control" name="image" value="{{$testimonial->image}}">
											</div>
										</div>
