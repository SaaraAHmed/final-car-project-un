					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="{{route('storeUser')}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									@csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="useName"  required="required" class="form-control"   name="userName" value="{{old('userName')}}">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="password" id="password"  required="required" class="form-control" name="password" value="{{old('password')}}" >
											</div>
										</div>
