									...
									@csrf
									  <div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="comment" required="required" class="form-control">{{old('comment')}}</textarea>
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="file" id="image" required="required" class="form-control"  name="image" value="{{old('image')}}">
											</div>
										</div>
